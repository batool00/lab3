...
```
answer:the africa is the most density continent and the south amreca is the most continent in plastic weste per cap.
...
ggplot(data = plastic_waste, 
  ...
  geom_violin()
```
answer:box plots provide a coarser sunnary of the data, provide more of a summary of a distribution can also be seen as an advantage in certain cases.  also the point in the graph or mapping it's most cleary than violin plots
...
geom_point()
```
aswer:the relationship is positive
...
geom_point()
```
anwer : europe (positive) relationship ,africa is the most a (mismanged _ plastic waste per cap)
